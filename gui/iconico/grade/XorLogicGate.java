...
public class XorLogicGate extends DiagramComponent {
    
    public XorLogicGate(ArrayList<String> inputList) {
        super(inputList);
        componentDimension.width = 45;
	...
	if (numInput * (fontMetrics.getAscent() + gap) > componentDimension.height) {
        ...
        // Draws the base
        g.drawArc(x + totalDimension.width - inputWidth, y, 10, totalDimension.height, 90, 180);
	...
	g.drawLine(outputWidth,
        ...
        int base = totalDimension.width - inputWidth - gap;
        g.drawArc(x + base, y, 10, totalDimension.height, 90, 180);
        g.drawArc(x + outputWidth, y, totalDimension.width - 17, 

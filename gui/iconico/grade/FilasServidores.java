...
public class FilasServidores extends Item implements ItemGrade {

    private int numServ;
    private int numQueues;
    
    public FilasServidores(int x, int y, int idLocal, int idGlobal, int imgId) {
        super(x, y, idLocal, idGlobal, imgId, "FilasServidores", null, null);
        setScheduler("SJF");
    }
    ...
    @Override
    public FilasServidores criarCopia(int posicaoMouseX, int posicaoMouseY, int idGlobal, int idLocal) {
        FilasServidores temp = new FilasServidores(posicaoMouseX, posicaoMouseY, idGlobal, idLocal, getImgId());
    ...
    public List<ItemGrade> getNosEscalonaveis() {
        ...
        for (ItemGrade link : getConexoesSaida()) {
            ...
            if (itemGrade instanceof Cluster || itemGrade instanceof FilasServidores) {
    ...
    private void getIndiretosEscalonaveis(ItemGrade itemGrade, List<ItemGrade> escalonaveis, Set internet) {
        for (ItemGrade link : itemGrade.getConexoesSaida()) {
            ...
            if (item instanceof Cluster || item instanceof FilasServidores) {

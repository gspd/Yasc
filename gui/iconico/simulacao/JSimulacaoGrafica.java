        ...
        this.progrSim = new ProgressoSimulacao() {
            ...
            public void print(String text, Color cor) {
                ...
                try {
                    ...
                    if (Main.languageResource.containsKey(text)) {
    ...
    public void run() {
        ...
        try {
            ...
            if (!sim.isFinalizar()) {
                ...
                progrSim.print(" -> ");
                janelaResultados = new JPanelResultados(this, metrica, redeDeFilas, tarefas, configuracao);
                progrSim.println("OK", Color.green);

...
import yasc.gui.JPanelResultados;
...
public class HtmlPane extends JEditorPane implements HyperlinkListener {
    ...
    public HtmlPane() {
        ...
        this.addHyperlinkListener(getInstance());
    }

    private HtmlPane getInstance() {
        return this;
    }
    ...
    private void jumpToAnchor(String desc) {
        ...
        try {
            ...
            Logger.getLogger(JPanelResultados.class.getName()).log(Level.SEVERE, null, ex);
        }

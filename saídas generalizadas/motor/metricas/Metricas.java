...
public class Metricas implements Serializable {
    ...
    private double UnidadesDesperdicio;
    ...
    public void calculaMedia() {
        ...
        metricasGlobais.setOciosidadeComputacao(metricasGlobais.getOciosidadeTarefa() / numeroDeSimulacoes);
        ...
        this.UnidadesDesperdicio = this.UnidadesDesperdicio / numeroDeSimulacoes;
    ...
    private void getMetricaFilaTarefa(List<Tarefa> tarefas, RedeDeFilas rede) {
        ...
        for (Tarefa no : tarefas) {
            ...
            if (no.getEstado() == Tarefa.CONCLUIDO) {
                ...
                UnidadesDesperdicio += no.getTamProcessamento() * no.getMflopsProcessado();
    ...
    private void addMetricasGlobais(MetricasGlobais global) {
        ...
        metricasGlobais.setOciosidadeComputacao(metricasGlobais.getOciosidadeTarefa() + global.getOciosidadeTarefa());
    ...
    private void addMetricaFilaTarefa(Metricas metrica) {
        ...
        this.UnidadesDesperdicio += metrica.UnidadesDesperdicio;

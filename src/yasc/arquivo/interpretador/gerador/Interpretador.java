package yasc.arquivo.interpretador.gerador;
...
class Interpretador implements InterpretadorConstants {
        ...
        private String pacote = "package yasc.externo;\u005cn\u005cn";
        private String imports = "import yasc.escalonador.Escalonador;\u005cn"
                                +"import yasc.motor.filas.Tarefa;\u005cn"
                                +"import yasc.motor.filas.servidores.CS_Processamento;\u005cn"
                                +"import yasc.motor.filas.servidores.CentroServico;\u005cn"
        ...
        public void addExpressaoRecurso(int tipoToken){
            ...
            case rLinkComu:
              ...
              if(!imports.contains("import yasc.motor.filas.servidores.CS_Comunicacao;")){
                imports = "import yasc.motor.filas.servidores.CS_Comunicacao;\u005cn" + imports;
              }

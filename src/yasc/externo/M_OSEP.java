...
public class M_OSEP extends Escalonador {
    ...
    public void iniciar() {
        ...
        for (CS_Processamento e : escravos) {
    ...
    public CS_Processamento escalonarRecurso() {
        ...
        for (int i = 0; i < escravos.size(); i++) {
            // Garantir que o escravo está de fato livre e que não há nenhuma tarefa em trânsito para o escravo
            if (filaEscravo.get(i).isEmpty() && processadorEscravos.get(i).isEmpty() && controleEscravos.get(i).Livre()) {
                if (selec == null) {
        ...
        if (selec != null) {
            // Indicar que uma tarefa será enviada e que , portanto , este escravo deve ser bloqueada até a próxima atualização

...
import yasc.escalonador.Carregar;
...
public class CS_Mestre extends CS_Processamento implements Mestre, Mensagens, CS_Vertice {
    ...
    public CS_Mestre(String id, String proprietario, double PoderComputacional, double Ocupacao, String Escalonador) {
        ...
        escalonador.setMestre(getInstance());
    ...
    @Override
    public void addConexoesSaida(CentroServico link) {
        conexoesSaida.add((CS_Comunicacao) link);
    }

    @Override
    public void addConexoesEntrada(CentroServico link) {
        conexoesEntrada.add((CS_Comunicacao) link);
    }
    ...
    public void determinarCaminhos() throws LinkageError {
        ...
        //Instancia objetos
        caminhoEscravo = new ArrayList<>(escravos.size());
    ...
    public void atenderAtualizacao(Simulacao simulacao, Mensagem mensagem) {
        ...
        //enviar resultados
        List<CentroServico> caminho = new ArrayList<>(CS_Maquina.getMenorCaminhoIndireto(this, (CS_Processamento) mensagem.getOrigem()));

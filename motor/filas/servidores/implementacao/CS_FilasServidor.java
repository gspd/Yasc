...
public class CS_FilasServidor extends CS_Comunicacao implements CS_Vertice {
    ...
    private int cont_sjf, cont_mjf;
    private final boolean Origem;
    private final boolean Destino;

    public CS_FilasServidor(String id, double TxServico, double TempoPreempcao, double TxAtraso, int Num_filas, String Escalonador, int Capacidade_Fila, double Prob_Falha_Serv, double Prob_Falha_Clie, boolean Capacidade, boolean Origem, boolean Destino) {
    ...
    public void saidaDeCliente(Simulacao simulacao, Tarefa cliente) {
        ...
        if (this == cliente.getOrigem()) {//acha o caminho a ser percorrido pelas tarefas
            ...
            if(this != cliente.getDestino()){
                cs = CS_FilasServidor.getMenorCaminho(cliente.getOrigem(), cliente.getDestino());
                if (cs == null) {
